public class examen20_21_2 {
    public static void main(String[] args) {
        ...
        if (tienePares) {
            System.out.printf("Las cifras pares del número %d son: %d\n", num, pares);
        } else {
            System.out.printf("El número %d no tiene cifras pares\n", num);
        }
        if (tieneImpares) {
            System.out.printf("Las cifras impares del número %d son (en orden inverso): %d\n", num, impares);
        } else {
            System.out.printf("El número %d no tiene cifras impares\n", num);
        }
    }
}
