public class prueba3 {
    public static void main(String[] args) {
        ...
        do {
          ...
          if (altura % 2 == 0 || altura < 3) System.out.print("Valor incorrecto. ");
        ...
        do {
          ...
          if (anchura < anchuraMinima) System.out.print("Valor incorrecto, introduzca un número mayor. ");
        } while (anchura < anchuraMinima);
